...
const Revolution = (props) => {
  ...
  const sections = [
    ...
    },
    {
      ...
      iconMaxWidth: matchesMD ? "30em" : "40em",
    ...
    },
    {
      ...
      iconAlt: "rocket",
      iconMaxWidth: matchesMD ? "42em" : "15em",
      iconMaxHeight: matchesMD ? "42em" : "70em",
  ...
  return (
    <Grid container direction="column" style={{ width: "100%" }}>
      ...
      <meta
        name="description"
        key="description"
        content="Visionary insights, coupled with cutting-edge technology, is a recipte for revolution. Get a free online estimate instantly."
      />
      <meta
        property="og:title"
        key="og:title"
      ...
      <meta
        property="og:url"
        key="og:url"
        content="arc.com/revolution" //come back here and change this link after deployment
      />
          ...
          <Grid item lg style={{ alignSelf: "center" }}>
            <img
              ...
              style={{
                ...
                maxHeight: section.iconMaxHeight,
              }}
            />
          </Grid>
        </Grid>
